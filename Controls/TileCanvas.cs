...
namespace Story_Crafter.Controls {
    public class TileCanvas : PictureBox {
        ...
        public void OnMouseClick(TileCanvas sender, MouseEventArgs e) {
            base.OnMouseClick(e);
        ...
        public void OnMouseDoubleClick(TileCanvas sender, MouseEventArgs e) {
        ...
        public void OnMouseWheel(TileCanvas sender, MouseEventArgs e) {
            base.OnMouseWheel(e);
